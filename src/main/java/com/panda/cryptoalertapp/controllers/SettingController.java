...
public class SettingController {
    ...
    public ResponseEntity<Object> saveNewSetting(@RequestParam AlertType.AlertTypes alertType, @RequestParam double targetPrice, @RequestParam boolean isTargetUp, @RequestParam int settingOwnerId) {
        User settingOwner = userService.findUserById(settingOwnerId);
        try {
            settingService.saveSetting(alertType, targetPrice, isTargetUp, settingOwner);
